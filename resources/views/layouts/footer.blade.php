    ...
    <div class="col-lg-12">
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-md-12 mb-3">
                ...
                <hr class="LineFooter">
                <ul>
                    <li><span class="O-que-seria-Customer" href="#"> {{trans('footer.blog_text_1')}}<br/><span class="text-style-1">{{trans('footer.data_footer')}}</span></span></li>
                    <li><span class="O-que-seria-Customer" href="#"> {{trans('footer.blog_text_2')}}<br/><span class="text-style-1">{{trans('footer.data_footer')}}</span></span></li>
